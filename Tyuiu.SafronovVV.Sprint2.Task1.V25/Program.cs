...
using Tyuiu.SafronovVV.Sprint2.Task1.V25.Lib;

namespace Tyuiu.SafronovVV.Sprint2.Task1.V25
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* (массив): (True, False, True, False, True, False), при a = 247, b = 155 *");
            Console.WriteLine("* , c = 325, d = 857                                                      *");
            Console.WriteLine("*                                                                         *");
            Console.WriteLine("***************************************************************************");
